...
@Model("partnerRoleModelViewRule",title = "角色模型视图规则")
class BasePartnerRoleModelViewRule:ContextModel("base_partner_role_model_view_rule","public") {
    companion object: RefSingleton<BasePartnerRoleModelViewRule> {
        override lateinit var ref: BasePartnerRoleModelViewRule
    }
