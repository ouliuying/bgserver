...
class ModelOne2ManyField constructor(model: ModelBase?,
                                     name:String,
        ...
        dynamic.model.query.mq.ModelField(model,name,fieldType,title), dynamic.model.query.mq.One2ManyField, dynamic.model.query.mq.PagingField