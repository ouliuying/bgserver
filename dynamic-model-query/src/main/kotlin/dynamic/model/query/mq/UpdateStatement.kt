...
class UpdateStatement(vararg val fieldValues: dynamic.model.query.mq.FieldValue, val setModel: ModelBase?): dynamic.model.query.mq.ModelExpression(){
    var whereExpression: dynamic.model.query.mq.ModelExpression?=null
    fun where(expression: dynamic.model.query.mq.ModelExpression?): dynamic.model.query.mq.UpdateStatement {
