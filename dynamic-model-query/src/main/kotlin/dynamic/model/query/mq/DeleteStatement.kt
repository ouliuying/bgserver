...
class  DeleteStatement(val fromModel: ModelBase): dynamic.model.query.mq.ModelExpression(){
    var whereExpression: dynamic.model.query.mq.ModelExpression?=null

    fun where(expression: dynamic.model.query.mq.ModelExpression?): dynamic.model.query.mq.DeleteStatement {
