...
open class JoinModel constructor(val model: ModelBase?, onConditions: dynamic.model.query.mq.ModelExpression, val operator:String="inner join", val criteria: dynamic.model.query.mq.ModelExpression?=null): dynamic.model.query.mq.ModelExpression(onConditions){
